const ALLOWED_TARGET = /^(?:\/health|\/api\/(?:nearby-addresses\/preview|investigations(?:\/draft|\/[a-f0-9]+(?:\/(?:start|resolutions))?)?|generated-graphs(?:\/[a-z0-9-]+(?:\/data)?)?)|\/generated-graphs\/[a-z0-9-]+(?:\/versions\/v\d+)?\/(?:graph-data\.json)?)$/;
